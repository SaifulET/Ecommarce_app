...
const AppNavBar = () => {
    ...
    const {WishCount,WishListRequest} = WishListStore()
            ...
            <nav className="navbar sticky-top bg-white navbar-expand-lg navbar-light py-3">
                <div className="container">
                    ...
                    <div className=" d-lg-flex">
                        ...
                        <Link to="/wish" type="button" className="btn ms-4 btn-light w-10 h-10 position-relative">
                        ...
                        {
                            isLogin()?<><Link type="button" className="btn ms-3 btn-success d-flex-lg" to="/profile">Profile</Link>
                                      <SubmitButton onClick={Logout} text="Logout"  className="btn ms-3 btn-success d-flex"/>
                                    </>:
                                    <>
